...
public class ParaYatirma  extends JFrame implements ActionListener{
    ...
    ParaYatirma(String pinnumber){
        ...
        JLabel text= new JLabel("Yatırmak istediğiniz tutarı giriniz:");
        ...
        deposit= new JButton("Para Yatır");
        deposit.setBounds(355,510,150,30);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource()== deposit){
            ...
            Date date= new Date();
            if(number.equals("")){
                JOptionPane.showMessageDialog(null,"Lütfen yatırmak istediğiniz tutarı giriniz!");
            
            }else {
                try{
                VeriTabani veritabani = new VeriTabani();
                String query= "insert into bank values('"+pinnumber+"','"+date+"', 'ParaYatir', '"+number+"')";
                veritabani.s.executeUpdate(query);
                JOptionPane.showMessageDialog(null,""+number+" TL para yatırma işlemi başarılı!");
                setVisible(false);
